...
public class UserController {
	...
	@ResponseBody
	public ResponseEntity<?>  getName(@PathVariable("userId") String userId)  throws RestClientException, IOException {
	...
	@ResponseBody
	public ResponseEntity<?>  getRole(@PathVariable("userId") String userId)  throws RestClientException, IOException {
		System.out.println("Consumer : getName" +userId);
	...
	public ResponseEntity<?> addStudent(@RequestBody Map<String, Object> studentMap) throws RestClientException, IOException {
		ResponseEntity<?> response = null;
		try {

			response = discoveryClass.discoveryResult("user-producer", "/register", HttpMethod.POST, studentMap);
