...
public class UserCRSRestApi {
	...
	public ResponseEntity<?> register(@RequestBody Student student) throws Exception {
		try {
			...
			String st = studentService.register(student.getName(), student.getUserId(), student.getPassword(),
			...
			return ResponseEntity.status(HttpStatus.OK).body(" you are successfully registered, please wait for Admin's Approval");
